...
CONSTRAINED_SYSTEM_PROMPT = (
    ...
    "A disfluency REQUIRES redundant or superseded speech. "
    ...
    "'let me rephrase', 'scratch that', and 'never mind'. Judge disfluency by "
    "this STRUCTURE — redundancy/abandonment — NOT by whether a cue word is "
    "present.\n\n"
    ...
    "it. Do NOT remove fillers as an independent edit; deterministic polish owns "
    "filler cleanup. Keep filler words and punctuation unless they are inside the "
    "superseded phrase removed for a real restart. Do NOT improve already-clean text. "
